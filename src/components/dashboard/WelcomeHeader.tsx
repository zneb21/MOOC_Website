...
const WelcomeHeader = () => {
  ...
  return (
    <PremiumCard className="bg-card rounded-2xl p-6 md:p-9 shadow-soft">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        
        <div className="flex flex-col">
          <h1 className="font-display text-2xl md:text-3xl font-bold text-foreground drop-shadow-md">
